...
2) Прописываем команду `git clone https://github.com/YasHKaRo/network-traffic-analysis`. После этого появится папка network-traffic-analysis в той папке, где мы находимся
3)
