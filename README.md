...
5) Настал новый день, и первое, с чего начинаем -- пишем `git pull` чтобы проверить, не появилось ли никаких изменений. И снова выбираем нужную ветку, работаем, добавляем изменения, пушим изменения. Объединять ветки уже буду самостоятельно.

Ну, вроде бы всё. В чате не материмся, мам любим и ценим, поехали
